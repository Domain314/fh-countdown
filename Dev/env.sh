...
# 5. Start BrowserSync
konsole --new-tab --noclose -e "bash -c 'cd $app_path && browser-sync start --proxy \"localhost:5000\" --files \"public/assets/scripts/**/*,public/backend/*,public/index.html\" --reload-delay 200'" &
